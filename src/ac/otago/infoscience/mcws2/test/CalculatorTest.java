...
public class CalculatorTest {
	...
	*/
	...
	public void testcalculateRiskCategory() {
		...
		assertEquals("1: ",Util.LOW_RISK ,Util.calculateRiskCategory(0.0026f));
		assertEquals("2: ",Util.LOW_RISK ,Util.calculateRiskCategory(0.00265f));
		assertEquals("3: ",Util.MODERATE_RISK ,Util.calculateRiskCategory(0.00275f));
		assertEquals("4: ",Util.MODERATE_RISK ,Util.calculateRiskCategory(0.0099f));
		assertEquals("5: ",Util.HIGH_RISK ,Util.calculateRiskCategory(0.0101f));
		assertEquals("6: ",Util.HIGH_RISK ,Util.calculateRiskCategory(0.0169f));
		assertEquals("7: ",Util.VERY_HIGH_RISK ,Util.calculateRiskCategory(0.0171f));
	...
	public void testgetRiskDescription() {
		assertEquals("1: ",Util.LOW_RISK_TEXT ,Util.getRiskDescription(Util.LOW_RISK));
		assertEquals("2: ",Util.MODERATE_RISK_TEXT ,Util.getRiskDescription(Util.MODERATE_RISK));
		assertEquals("3: ",Util.HIGH_RISK_TEXT ,Util.getRiskDescription(Util.HIGH_RISK));
		assertEquals("4: ",Util.VERY_HIGH_RISK_TEXT ,Util.getRiskDescription(Util.VERY_HIGH_RISK));
